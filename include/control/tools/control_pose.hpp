...
/**Calculates yaw based on quaternion orientationi
 *\param T Must contain x, y, z and w members
 */
template<typename T> double quat2yaw(T q) {
 ...
 * \param T Must contain x, y, z and w members
 */
template<typename T> double quat2mavrosyaw(T q) {
